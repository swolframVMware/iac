...
short_description: Retrieves trusted certificates from SDDC Manager.
description:
    - This module retrieves all trusted certificates from the SDDC Manager appliance's trust store.
...
class SddcManagerTrustedCertificatesInfo:
    """This class represents the trusted certificates information retrieval in SDDC Manager.
    ...
    Methods:
        get_trusted_certificates(self): Retrieves trusted certificates from SDDC Manager.
    ...
    def get_trusted_certificates(self):
        """Retrieves trusted certificates from SDDC Manager."""
        try:
...
def main():
    ...
    trusted_certs_info = SddcManagerTrustedCertificatesInfo(module)
