...
class ModuleDocFragment(object):
    DOCUMENTATION = r"""
options:
    vcf_installer_hostname:
        description: The hostname or IP address of the VCF Installer instance.
        required: true
        type: str
    vcf_installer_user:
        description: The username to authenticate with the VCF Installer instance.
        required: true
        type: str
    vcf_installer_password:
        description: The password to authenticate with the VCF Installer instance.
        required: true
        type: str
"""
