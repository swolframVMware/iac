...
options:
        sddc_manager_hostname:
            description:
                - The hostname or IP address of the SDDC Manager instance.
            required: true
            type: str
        sddc_manager_user:
            description:
                - The username to authenticate with the SDDC Manager instance.
            required: true
            type: str
        sddc_manager_password:
            description:
                - The password to authenticate with the SDDC Manager instance.
            required: true
            type: str
    """
