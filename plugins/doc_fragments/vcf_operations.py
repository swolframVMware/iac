...
class ModuleDocFragment(object):
    DOCUMENTATION = r"""
options:
    vcf_operations_hostname:
        description:
            - The hostname or IP address of the VCF Operations deployment.
        required: true
        type: str
    vcf_operations_user:
        description:
            - The username to authenticate with the VCF Operations deployment.
        required: true
        type: str
    vcf_operations_password:
        description:
            - The password to authenticate with the VCF Operations deployment.
        required: true
        type: str
"""
